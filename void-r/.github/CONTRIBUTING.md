...
If you wish to contribute to Void, feel free to fork the repository and submit a pull request.
...
--->
## Prerequisites
The following prerequisites must be met before installing Void:
{{setup.prerequisites}}
...
2. Code your ideas
3. [Submit a pull request](https://github.com/Wessel/Void/compare)
